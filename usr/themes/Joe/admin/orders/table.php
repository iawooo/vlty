						...
						<div class="operate">
							...
							<div class="btn-group btn-drop">
								...
								<ul class="dropdown-menu">
									<li><a lang="<?php _e('你确认要删除这些订单吗?'); ?>" href="<?php $options->adminUrl('extending.php?panel=..%2Fthemes%2F' . urlencode(THEME_NAME) . '%2Fadmin%2Forders.php&action=delete') ?>"><?php _e('删除') ?></a>
									</li>
								</ul>
							</div>
						</div>
