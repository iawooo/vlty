	...
	if ($this->fields->mode == "default" || !$this->fields->mode) : ?>
		<li class="joe_list__item wow default">
			...
			<a href="<?php $this->permalink() ?>" class="thumbnail" title="<?php $this->title() ?>" target="<?php $this->options->Jsearch_target() ?>" rel="noopener noreferrer">
				<img referrerpolicy="no-referrer" rel="noreferrer" width="100%" height="100%" class="lazyload error-thumbnail" src="<?php joe\getLazyload() ?>" data-src="<?= joe\getThumbnails($this)[0] ?>" alt="<?php $this->title() ?>" />
	...
	<?php elseif ($this->fields->mode == "multiple") : ?>
		<li class="joe_list__item wow multiple">
			...
			<a href="<?php $this->permalink() ?>" class="thumbnail" title="<?php $this->title() ?>" target="_blank" rel="noopener noreferrer">
				...
				<?php for ($x = 0; $x < 3; $x++) : ?>
					<img referrerpolicy="no-referrer" rel="noreferrer" width="100%" height="100%" class="lazyload error-thumbnail" src="<?php joe\getLazyload() ?>" data-src="<?php echo $image[$x]; ?>" alt="<?php $this->title() ?>" />
				<?php endfor; ?>
			</a>
			<div class="meta">
				<div class="item-tags scroll-x no-scrollbar mb6"><?= joe\get_archive_tags($this) ?></div>
