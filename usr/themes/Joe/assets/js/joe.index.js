				...
				if (_.mode === 'default') {
					...
					<li class="joe_list__item wow default">
						...
						<a href="${_.permalink}" class="thumbnail" title="${_.title}" target="${_.target}" rel="noopener noreferrer">
							...
							<img referrerpolicy="no-referrer" rel="noreferrer" width="100%" height="100%" class="lazyload error-thumbnail" src="${_.lazyload}" data-src="${_.image[0]}" alt="${_.title}" />
...
document.addEventListener(Joe.options.Turbolinks == 'on' ? 'turbolinks:load' : 'DOMContentLoaded', Joe.DOMContentLoaded.index, { once: true });